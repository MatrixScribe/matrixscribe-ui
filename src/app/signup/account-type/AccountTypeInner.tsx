...
export default function AccountTypeInner() {
      ...
      <div className="relative z-10 px-6 py-16 flex flex-col items-center">
        ...
        <div className="mt-10 w-full max-w-xl grid grid-cols-1 gap-6">
          ...
          <div
            ...
            className="cursor-pointer rounded-3xl p-6 bg-white/40 backdrop-blur-xl border border-black/10 shadow hover:shadow-xl transition"
          >
